...
public class UploadMakananActivity extends AppCompatActivity implements UploadMakananConstract.View {
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.btn_upload:
                ...
                mUploadMakananPresenter.uploadMakanan(this, filePath, edtName.getText().toString(), edtDesc.getText().toString(), mIdCategory);
                break;
        }
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        //Mengecek apakah code dan data ada
        if (requestCode == Constant.REQUEST_CODE && resultCode == RESULT_OK && data != null && data.getData() != null){
            ...
            try{
                //Mengubah file image menjadi file bitmap
